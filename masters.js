    ...
    <div class="stats">
        ...
        <div class="stat">
            <div class="statTitle">Trading Days</div>
            <div class="statValue">${master.days}</div>
        </div>
    
        <div class="stat">
            <div class="statTitle">Growth</div>
            <div class="statValue">+${master.growth}%</div>
        </div>
    
        <div class="stat">
            <div class="statTitle">Max Drawdown</div>
            <div class="statValue">${master.drawdown}%</div>
        </div>
    
        <div class="stat">
            <div class="statTitle">Followers</div>
            <div class="statValue">${master.followers}</div>
        </div>
